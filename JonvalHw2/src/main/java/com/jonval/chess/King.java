        ...
        switch (color) {
            case WHITE:
                if (Arrays.equals(positionGO, new int[]{6, 0})
                    ...
                    board[7][0] = PieceFactory.newPiece(Type.NULL, Team.NULL);
                    board[positionCURRENT[0]][positionCURRENT[1]] = PieceFactory.newPiece(Type.NULL, Team.NULL);
                    castling.falseWhiteCastling();
                    return true;
                }
                if (Arrays.equals(positionGO, new int[]{2, 0})
                    ...
                    board[0][0] = PieceFactory.newPiece(Type.NULL, Team.NULL);
                    board[positionCURRENT[0]][positionCURRENT[1]] = PieceFactory.newPiece(Type.NULL, Team.NULL);
                    castling.falseWhiteCastling();
                    return true;
                }
            case BLACK:
                if (Arrays.equals(positionGO, new int[]{6, 7})
                    ...
                    board[7][7] = PieceFactory.newPiece(Type.NULL, Team.NULL);
                    board[positionCURRENT[0]][positionCURRENT[1]] = PieceFactory.newPiece(Type.NULL, Team.NULL);
                    castling.falseBlackCastling();
                    return true;
                }
                if (Arrays.equals(positionGO, new int[]{2, 7})
                    ...
                    board[0][7] = PieceFactory.newPiece(Type.NULL, Team.NULL);
                    board[positionCURRENT[0]][positionCURRENT[1]] = PieceFactory.newPiece(Type.NULL, Team.NULL);
                    castling.falseBlackCastling();
                    return true;
                }
